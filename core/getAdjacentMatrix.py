...
from core.getCrossing import config
from utils.db.df_insert_ignore import save_dataframe

mysql_conn = create_engine(r"mysql+mysqldb://root:123456@node01/spark")
...
# 输出
adj_table = config["table"]["mysql"]["adj_table"]
...
if __name__ == '__main__':
    ...
    # # save_dataframe(mysql_conn, isAdjDF, isAdjTable)
